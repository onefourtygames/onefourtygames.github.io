    ...
    const services = [
        {
            ...
            title: t('services.items.game_dev.title'),
            description: t('services.items.game_dev.desc'),
            features: t('services.items.game_dev.features', { returnObjects: true }) as string[]
        },
        {
            icon: <Smartphone size={40} className="text-purple-400" />,
            title: t('services.items.app_dev.title'),
            description: t('services.items.app_dev.desc'),
            features: t('services.items.app_dev.features', { returnObjects: true }) as string[]
        },
        {
        ...
        <div className="pt-24 min-h-screen">
            ...
            <section className="py-20 text-center container mx-auto px-4">
                <div className="glass-panel p-12 rounded-3xl max-w-4xl mx-auto border border-purple-500/30 relative overflow-hidden">
                    ...
                    <h2 className="text-4xl font-bold mb-6 relative z-10">{t('services.cta.title')}</h2>
